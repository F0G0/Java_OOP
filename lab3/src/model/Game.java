...
public class Game extends Observable {
   ...
   public int[][] getSolution() {
    ...
    public void newGame() {
        ...
        setChanged();
        notifyObservers(UpdateStatus.NEW_GAME);
    }

    public void quickSolution(){
    	selectedNumber=0;
    	setChanged();
    	notifyObservers(UpdateStatus.SOLUTION);
    }

    public void setFinishGame(){
    	GameStatus();
    	setChanged();
    	notifyObservers(UpdateStatus.FINISH);
    }
    ...
    public void checkGame() {
        ...
        selectedNumber = 0;
        setChanged();
        notifyObservers(UpdateStatus.CHECK);
    }

    public void setHelp(boolean help) {
        this.help = help;
        setChanged();
        notifyObservers(UpdateStatus.HELP);
    }

    public void setSelectedNumber(int selectedNumber) {
        this.selectedNumber = selectedNumber;
        setChanged();
        notifyObservers(UpdateStatus.SELECTED_NUMBER);
    }
